    ...
    <Container style={containerStyle}>
      ...
      <Paper radius="md" style={paperStyle}>
        ...
        <List mb="xl" spacing="sm">
          ...
          <List.Item>
            You have the right to request deletion of your user data, in accordance with various laws governing data protection. Please contact <Anchor href="mailto:support@cowatch.me">support@cowatch.me</Anchor> to request user data deletion.
          </List.Item>
        </List>
        ...
        <List mb="sm" spacing="sm">
          <List.Item>
            The service provides the ability to search and play YouTube videos. Google/YouTube may use data provided to the search service in accordance with the <Anchor href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Google Privacy Policy</Anchor>.
          </List.Item>
        </List>
      </Paper>
    </Container>
  ...
  return (
    <Container style={containerStyle}>
      ...
      <Paper radius="md" style={paperStyle}>
        ...
        <Text mb="md">By using this service you agree to the following terms:</Text>
        <List mb="xl" spacing="sm">
        ...
        <Title order={2} size="h4" mb="sm">YouTube</Title>
        <Text mb="sm">
          The service provides the ability to search and play YouTube videos. By using the YouTube search you agree to the <Anchor href="https://www.youtube.com/t/terms" target="_blank" rel="noopener noreferrer">YouTube Terms of Service</Anchor>.
        </Text>
      </Paper>
    </Container>
  );
...
export const FAQ = () => {
  return (
    <Container style={containerStyle}>
      <BackButton />
      <Title order={1} mb="xl" style={{ color: "var(--color-violet)", textAlign: "center" }}>
      ...
      <Accordion variant="separated" styles={{
        ...
        <Accordion.Item value="vbrowser">
          <Accordion.Control><Text fw={500}>What's a VBrowser?</Text></Accordion.Control>
          <Accordion.Panel>
        ...
        <Accordion.Item value="vbrowser-stop">
          <Accordion.Control><Text fw={500}>Why did my VBrowser session stop?</Text></Accordion.Control>
          <Accordion.Panel>
        ...
        <Accordion.Item value="vbrowser-not-available">
          <Accordion.Control><Text fw={500}>How do I access sites that have a "not available" message in the VBrowser?</Text></Accordion.Control>
          <Accordion.Panel>
        ...
        <Accordion.Item value="audio-screensharing">
          <Accordion.Control><Text fw={500}>How come I'm not getting any audio when screensharing?</Text></Accordion.Control>
          <Accordion.Panel>
        ...
        <Accordion.Item value="room-limit">
          <Accordion.Control><Text fw={500}>Is there a limit to how many people can be in a room?</Text></Accordion.Control>
          <Accordion.Panel>
        ...
        <Accordion.Item value="cowatch-link">
          <Accordion.Control><Text fw={500}>I own a website and I'd like to have a link that generates a CoWatch room with a specific video already set. How do I do this?</Text></Accordion.Control>
          <Accordion.Panel>
            You can link to <Anchor href="https://www.cowatch.me/create?video=URL_HERE" target="_blank" rel="noopener noreferrer">https://www.cowatch.me/create?video=URL_HERE</Anchor> to do this!
          </Accordion.Panel>
        </Accordion.Item>
      </Accordion>
    </Container>
