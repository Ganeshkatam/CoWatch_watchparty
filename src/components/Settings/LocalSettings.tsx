...
//           {window.localStorage.getItem('cowatch-setting') ||
...
export function getCurrentSettings(): Settings {
  const setting = window.localStorage.getItem("cowatch-setting");
  try {
...
export function updateSettings(newSetting: string) {
  window.localStorage.setItem("cowatch-setting", newSetting);
}
